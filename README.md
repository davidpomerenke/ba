...
1. Das Differenzprinzip in der Leximin-Formulierung steht im Widerspruch zum Prinzip der fairen Aggregation, welches eine Prämisse für das Anti-Neutralitäts-Argument darstellt.
...
2. L'argument contre la neutralité a la prémisse implicite que l'intervalle neutre dans lequel des gens peuvent être ajoutés à une population est un intervalle propre. Le moyen-utilitarisme suggère de modifier un peu l'intuition de la neutralité pour qu'elle utilise un seul niveau neutre au lieu qu'un intervalle propre neutre. À cause de l'incertitude associée, cette modification est en effet en quelque sort pareil à l'intuition originale.
...
2. Argumentum contra neutralitatem impliciter praemittit intervallum neutrale esse verum intervallum. Medii utilitatis principium admonit leviter mutare intuitionem neutralitatis, ut sit nivellum neutralis et non verum intervallum neutralis. Incertitudinis causa, hoc mutatio intuitionem neutralitatis similem esse habet.
