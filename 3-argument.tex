...
\begin{center}
  ...
  \scriptsize The well-being of the persons in scenarios A, B and C with corresponding utility functions $u_a$, $u_b$, $u_c$. Copied from \citeNP[p.~177]{broome_2012}.
\end{center}
\end{Counterexample}
